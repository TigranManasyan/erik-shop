...
if(isset($_POST['name'])
    ...
    if(move_uploaded_file($file['tmp_name'], $upload_dir . '/' . $file_name)){
        if(query("INSERT INTO products (user_id, name, price, category_id, qty, is_active, description, image) VALUES ($user_id, '$name', $price, $category_id, $qty, $is_active, '$description', '$file_name')")) {
            $_SESSION['msg'] = [
                'type' => 'create_success',
